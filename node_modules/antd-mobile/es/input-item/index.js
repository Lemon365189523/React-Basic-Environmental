    ...
    _createClass(InputItem, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(TextInput, _extends({ ref: 'input', clearButtonMode: clear ? 'while-editing' : 'never', underlineColorAndroid: 'transparent' }, restProps, valueProps, { style: [styles.input, inputStyle], keyboardType: keyboardType, onChange: function onChange(event) {
