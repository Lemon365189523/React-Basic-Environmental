...
var ActivityIndicator = function (_React$Component) {
    ...
    _createClass(ActivityIndicator, [{
        ...
        value: function render() {
            ...
            var spinnerClass = classNames((_classNames2 = {}, _defineProperty(_classNames2, prefixCls + '-spinner', true), _defineProperty(_classNames2, prefixCls + '-spinner-lg', !!toast || size === 'large'), _defineProperty(_classNames2, prefixCls + '-spinner-white', !!toast || color === 'white'), _classNames2));
            if (animating) {
                if (toast) {
