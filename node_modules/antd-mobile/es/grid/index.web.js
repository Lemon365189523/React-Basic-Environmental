    ...
    _createClass(Grid, [{
        ...
        value: function render() {
            ...
            var columnNum = restProps.columnNum,
                ...
                _restProps$onClick = restProps.onClick,
                _onClick = _restProps$onClick === undefined ? function () {} : _restProps$onClick,
            ...
            for (var i = 0; i < rowCount; i++) {
                ...
                var _loop = function _loop(j) {
                    ...
                    if (dataIndex < dataLength) {
                        ...
                        rowArr.push(React.createElement(Flex.Item, { key: 'griditem-' + dataIndex, style: colStyle }));
                    }
                };
            ...
            if (isCarouselMode) {
                if (initialSlideWidth > 0) {
                    renderEl = React.createElement(
                        Carousel,
                        _extends({ initialSlideWidth: initialSlideWidth }, restPropsForCarousel),
