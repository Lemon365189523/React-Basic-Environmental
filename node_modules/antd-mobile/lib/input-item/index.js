...
var noop = function noop() {}; /* tslint:disable:jsx-no-multiline-js */
    ...
    (0, _createClass3['default'])(InputItem, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_reactNative.TextInput, (0, _extends3['default'])({ ref: 'input', clearButtonMode: clear ? 'while-editing' : 'never', underlineColorAndroid: 'transparent' }, restProps, valueProps, { style: [styles.input, inputStyle], keyboardType: keyboardType, onChange: function onChange(event) {
